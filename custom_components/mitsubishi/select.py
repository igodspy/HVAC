...
from .entity_config import get_entity_icon, get_entity_name
from .const import (
    CONF_NAME,
    DATA_MITSUBISHI,
    DEVICES,
...
def _device_info(name):
    """Return common device information."""
    return {
...
async def async_setup_entry(hass, entry, async_add_entities):
    """Set up Mitsubishi select entities from a config entry."""
...
class MitsubishiVerticalSwingSelect(SelectEntity):
    ...
    def __init__(self, name, device):
        ...
        self._attr_name = get_entity_name("select", PAR_SWING_MODE)
    ...
    def device_info(self):
        ...
        return _device_info(self._name)
...
class MitsubishiHorizontalSwingSelect(SelectEntity):
    ...
    def __init__(self, name, device):
        ...
        self._api = device.api
        self._attr_has_entity_name = True
        self._attr_name = get_entity_name("select", PAR_HSWING_MODE)
...
class MitsubishiInstallPositionSelect(SelectEntity):
    ...
    def __init__(self, name, device):
        ...
        self._api = device.api
        self._attr_has_entity_name = True
        self._attr_name = get_entity_name("select", PAR_INSTALL_POSITION)
